...
An end-to-end AI/ML powered telematics insurance analytics platform built using Python, Plotly Dash, GLM, and GA2M/EBM models to simulate real-world commercial auto underwriting and pricing workflows.
